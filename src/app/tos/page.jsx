...
export default function TosPage() {
  return (
    <div style={{maxWidth:800,margin:'40px auto',padding:'0 20px',color:'var(--text)',lineHeight:1.8}}>
      ...
      <section style={{marginBottom:28}}><h2 style={{fontSize:18,fontWeight:600,marginBottom:8,color:'#c8ccd6'}}>4. Fees</h2><p style={{color:'var(--text2)'}}>XRPHarbor charges a 3% commission on completed sales (1.5% for Pro members), collected via a separate on-chain payment at checkout.</p></section>
