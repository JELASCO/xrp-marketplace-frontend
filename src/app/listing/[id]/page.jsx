      ...
      <div className="listing-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:32,marginTop:24}}>
        ...
        <div>
          <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',gap:12}}>
            ...
            <button onClick={()=>{ if(typeof navigator!=='undefined'&&navigator.clipboard){navigator.clipboard.writeText(window.location.href);setShareCopied(true);setTimeout(()=>setShareCopied(false),1500);} }}
          ...
          <div style={{background:'var(--surface)',border:'1px solid var(--border)',borderRadius:10,padding:'12px 16px',marginBottom:20,display:'flex',alignItems:'center',gap:12}}>
            ...
            <div style={{flex:1}}><div style={{color:'var(--text)',fontWeight:600,fontSize:14}}>{listing.username}{listing.is_verified && <span style={{marginLeft:6,fontSize:11,background:'rgba(16,185,129,0.15)',color:'var(--green)',borderRadius:5,padding:'1px 6px',fontWeight:700}}>✓ Verified</span>}{listing.seller_is_pro && <span style={{marginLeft:6,fontSize:11,background:'linear-gradient(135deg,#3b82f6,#8b5cf6)',color:'#fff',borderRadius:5,padding:'1px 6px',fontWeight:700}}>PRO</span>}</div><div style={{color:'var(--text3)',fontSize:12}}>{listing.views} views</div></div>
